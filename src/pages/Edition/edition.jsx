...
const Edition = ()=>{
  ...
  React.useEffect(()=>{
    Axios.get('https://poorvikadashboard.herokuapp.com/api/v1/District',{
    }).then((response) => {
      // console.log("edition",response.data);
  ...
  React.useEffect(()=>{
    ...
    React.useEffect(()=>{
      Axios.get('https://poorvikadashboard.herokuapp.com/api/v1/State',{
      }).then((response) => {
  ...
  const handleSubmit=(e) =>{
    e.preventDefault();
    Axios.post('https://poorvikadashboard.herokuapp.com/api/v1/Edition_Add',{
      edition: idofedition,
